...
<div className="relative h-screen w-full text-center p-8">

   
    <h2 className="text-amber-400 font-bold text-2x1 sm:text-3xl md:text-4xl lg:text-5xl">
        Why U Choose Us?
    </h2>
    ...
    <div className="flex flex-wrap items-center mt-20 text-left text-center">
        ...
        <div className="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
           ...
           <form className="w-full   shadow-md rounded px-8 pt-6 pb-8 mb-4 hover:scale-105 hover:shadow-xl">
            ...
            <strong>Chef Jameel</strong> is a talented culinary expert from Pakistan, widely recognized for his mastery in crafting authentic, flavorful biryani. With years of experience, Chef Jameel has honed his skills, blending traditional spices and techniques that capture the rich heritage of Pakistani cuisine. His biryani is celebrated for its perfectly layered rice, tender meat, and an exquisite balance of spices that leaves a memorable taste in every bite. Known for his attention to detail and passion for his craft, Chef Jameel has become a go-to professional for biryani lovers seeking a genuine taste of Pakistan.
            </p> </form>
        </div>
    </div>
    ...
    <div className="flex flex-wrap items-center mt-20 text-left text-center">
        ...
        <div className="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
            ...
            <form className="w-full   shadow-md rounded px-8 pt-6 pb-8 mb-4 hover:scale-105 hover:shadow-xl">
            <p className="sm:text-lg mt-6 hover:scale-105 hover:shadow-xl">
            <strong>Chef Hammad </strong> is a culinary talent with a flair for crafting mouth-watering burgers and comfort foods. Known for his creative combinations and perfecting every detail, he has built a reputation for delivering juicy, flavorful burgers that are a hit with food lovers. Chef Hammad’s expertise shines in his ability to balance textures and flavors, whether he’s crafting a classic cheeseburger or adding a twist with gourmet toppings. His dedication to quality ingredients and his passion for comfort food make him a go-to chef for anyone looking for a delicious, satisfying burger experience.
            </p></form>
